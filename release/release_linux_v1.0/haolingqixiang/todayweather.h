...
public:
    ...
    bool getweather(int month, int day, int hour, QString &temp, QString &hum, QString &wea, QString &wd, QString &ws);
    void updateTooltip(QPointF point, bool state);
    void onWeatherRequest();
    void onWeatherInfoReady(const QJsonObject& weatherData);
