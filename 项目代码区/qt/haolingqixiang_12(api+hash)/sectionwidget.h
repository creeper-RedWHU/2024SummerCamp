...
public:
    explicit SectionWidget(const QString &weather, const QString &temp, const QString &winddir, const QString &windstr,const QString &humidity, QWidget *parent = nullptr);
