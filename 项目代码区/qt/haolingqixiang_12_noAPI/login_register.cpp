...
{
    QSqlQuery query;
    query.prepare("SELECT password, identity FROM haolins WHERE account = :username");
...
{
    QSqlQuery query;
    query.prepare("SELECT account FROM haolins WHERE account = :username");
    query.bindValue(":username", username);
...
{
    QSqlQuery query;
    query.prepare("INSERT INTO haolins (account, password) VALUES (:username, :password)");
    query.bindValue(":username", username);
