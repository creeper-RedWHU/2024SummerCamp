    ...
    , ui(new Ui::Widget)
{
    ...
    connect(btn2, &QPushButton::clicked, this, &Widget::onRegisterClicked);
...
bool Widget::authenticate(const QString &username, const QString &password)
{
    QSqlQuery query;
...
bool Widget::userExists(const QString &username)
{
    QSqlQuery query;
...
void Widget::saveUser(const QString &username, const QString &password)
{
    QSqlQuery query;
