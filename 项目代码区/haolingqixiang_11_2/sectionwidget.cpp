...
SectionWidget::SectionWidget(const QString &weather, const QString &maxt, const QString &mint, const QString &winddir, const QString &windstr, QWidget *parent)
    : QWidget(parent)
{
    // 创建标签
    ...
    mainLayout->addWidget(maxtLabel);
    mainLayout->addWidget(mintLabel);
